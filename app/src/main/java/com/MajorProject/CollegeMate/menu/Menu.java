package com.MajorProject.CollegeMate.menu;
...
import com.MajorProject.CollegeMate.user.MyFollowing;
import com.MajorProject.CollegeMate.welcome.IntroLast;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       sharedPref = new SharedPref(this);
        ...
        invite.setOnClickListener(v -> {
            String shareBody = "CollegeMate - Your College Buddy!" + " Download now on play store \nhttps://play.google.com/store/apps/details?id=com.MajorProject.CollegeMate";
