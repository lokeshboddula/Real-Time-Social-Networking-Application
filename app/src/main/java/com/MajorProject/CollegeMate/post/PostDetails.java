package com.MajorProject.CollegeMate.post;
...
import com.MajorProject.CollegeMate.adapter.AdapterComments;
import com.MajorProject.CollegeMate.groups.ShareGroupActivity;
import com.MajorProject.CollegeMate.model.ModelComments;
...
public class PostDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    private Uri saveImageToShare(Bitmap bitmap) {
        ...
        try {
            ...
            stream.flush();
            stream.close();
            uri = FileProvider.getUriForFile(this, "com.MajorProject.CollegeMate.fileprovider", file);
